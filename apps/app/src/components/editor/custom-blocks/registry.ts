...
export const CUSTOM_BLOCK_REGISTRY = [
  ...
  },
  {
    ...
    description: 'Possessivpronomen nach Kasus, Genus und Person darstellen.',
    category: 'Content',
    keywords: ['possessivpronomen', 'pronomen', 'kasus', 'genus', 'mein', 'dein'],
    Icon: Table,
    insert: (editor) => editor.chain().focus().insertPossessivePronoun().run(),
  },
  {
    type: 'indefiniteArticle',
    label: 'Unbestimmter Artikel',
    description: 'Den unbestimmten Artikel nach Genus und Kasus darstellen.',
    category: 'Content',
    keywords: ['unbestimmter artikel', 'artikel', 'deklination', 'kasus', 'ein', 'eine'],
    Icon: Table,
    insert: (editor) => editor.chain().focus().insertIndefiniteArticle().run(),
  },
  {
