...
const EN_TO_DE: Record<string, string> = {
  ...
  'Clue formats': 'Hinweisformate',
  'Definition or paraphrase': 'Definition oder Umschreibung',
  'Blank sentence': 'Lückensatz',
  'Use definition clues': 'Definitionshinweise verwenden',
  'Use blank sentence clues': 'Lückensätze verwenden',
  'Enable at least one clue format.': 'Aktivieren Sie mindestens ein Hinweisformat.',
  ...
  'Logic difficulty': 'Logische Schwierigkeit',
  'Question language': 'Sprache der Frage',
  'Option language': 'Sprache der Antwortoptionen',
  'Default (text level)': 'Standard (Textniveau)',
  'Slightly easier than text': 'Etwas einfacher als der Text',
  ...
  'Language proficiency override': 'Sprachniveau überschreiben',
  'CEFR sublevel': 'GER-Teilniveau',
  'Position within sublevel': 'Position innerhalb des Teilniveaus',
  'Beginning': 'Am Anfang',
