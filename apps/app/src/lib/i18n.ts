...
export const messages = {
  en: {
    ...
    documents: {
      ...
      publish: 'Publish',
      publishError: 'Could not publish worksheet.',
    ...
    editor: {
      ...
      jsonCopiedPartial: 'JSON copied without {types} — these blocks have no JSON import support.',
      jsonCopyFailed: 'JSON could not be copied.',
    },
    home: {
  ...
  de: {
    ...
    documents: {
      ...
      publishError: 'Arbeitsblatt konnte nicht veröffentlicht werden.',
    ...
    editor: {
      ...
      jsonCopiedPartial: 'JSON ohne {types} kopiert – diese Blöcke haben keine JSON-Importunterstützung.',
