...
export type InlineChoiceItem = InlineChoiceSentence | InlineChoiceDivider;
                      ...
                      <span className="inline-choice-node__choice-group">
                        {part.choices.map((choice, optionIndex) => (
                          <span
                            ...
                            data-example={isExample && choice.correct}
                            key={`${part.index}-${optionIndex}-${choice.text}`}
                          >
                            <BlockChoiceIndicator
                              checked={isExample && choice.correct}
                              example={isExample && choice.correct}
